...
import com.qf.bigdata.sharecar.enumes.VehicleTypeEnum;
...
public class CommonUtil {
	...
	public static GisDO getRandomGisDO(){
		List<GisDO> gisDOs = AmapGisUtil.getGISDOs();
		return CommonUtil.getRandomElementRange(gisDOs);
	}

	public static String getRandomVehicleType(){
		List<String> vechicleTypes = VehicleTypeEnum.getVehicleTypes();
		String vechicleType = CommonUtil.getRandomElementRange(vechicleTypes);
		return vechicleType;
	}
