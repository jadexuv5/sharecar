...
//    private static final String KEY = "83c744016bbc5d85b429516831979886";
    ...
    public static final String GIS_CSV_FILE = "areacode/gis_location.csv";
    ...
    public static Double getRandomGIS(String dict){
        ...
        if(StringUtils.isNotEmpty(dict)){
            ...
            while(flag){
                ...
                if(KEY_LAT.equalsIgnoreCase(dict)){
                    if(value.compareTo(CommonConstant.LATITUDE_BJ_MAX) <= 0){
                        flag=false;
                        break;
                    }
                }else{
                    if(value.compareTo(CommonConstant.LONGITUDE_BJ_MAX) <= 0){
                        flag=false;
                        break;
                    }
                }
