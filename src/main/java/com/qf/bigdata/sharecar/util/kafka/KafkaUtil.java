...
import com.qf.bigdata.sharecar.util.zookeeper.ZKClientUtil;
...
public class KafkaUtil {
    ...
    public static final String KAFKA_CONFIG = "kafka/kafka.properties";
...
//     */
    ...
    public static void main(String[] args){
       ...
       // kafkaUtil.createTopic(CommonConstant.TOPIC_TEST, partitions, replication);
