CREATE TABLE sharecar.sync_mysql_hive (
  ...
  `dicts` varchar(10) NOT NULL DEFAULT 'm2h' COMMENT 'mysql->hive m2h| hive->mysql h2m',
  `fieldMap` varchar(100) NOt NULL DEFAULT '' COMMENT '转换字段',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_mysql_hive` (`db_mysql`,`table_mysql`,`db_hive`,`table_hive`,`dicts`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


//==========================================================

insert into sharecar.sync_mysql_hive(db_mysql, table_mysql, db_hive, table_hive, dicts)
values('sharecar','t_user','default','sharecar_user','h2m');
